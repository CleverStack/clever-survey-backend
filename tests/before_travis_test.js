...
function copyModule () {
    var defered = Q.defer()
      ...
      , toDir   = path.join( __dirname, '../', prName, 'backend', 'modules', 'clever-survey' );
...
function bundled(  ) {
    ...
    console.log( 'step #5 - added clever-survey module in bundledDependencies\n' );
    ...
    fs.readFile ( file, function ( err, data ) {
        ...
        data.bundledDependencies.push ( 'clever-survey' );
